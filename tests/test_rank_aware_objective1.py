...
Distribution fixtures include the canonical mathematical mean explicitly;
P50 remains the median and is retained independently.
"""
import sys, os
...
def _squad():
    return {
        1: {"distribution": {"mean": 5.0, "p50": 5.0, "p90": 9.0, "variance": 2.0}},
        2: {"distribution": {"mean": 4.0, "p50": 4.0, "p90": 8.0, "variance": 1.0}, "is_bench": True},
        3: {"distribution": {"mean": 6.0, "p50": 6.0, "p90": 10.0, "variance": 3.0}, "is_captain": True},
    }
